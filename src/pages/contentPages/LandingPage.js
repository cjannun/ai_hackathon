...
function LandingPage() {
    return (
        <div className='flex-fill landing' >
            ...
            <div style={{padding: "0rem 8rem", marginTop: "2rem", fontFamily: "Segoe UI", fontSize: "2vh", color: "#2D283E", textAlign: "justify"}}>
            ...
            <div style={{textAlign: "right", paddingRight: "2rem", fontFamily: "Segoe UI", fontSize: "2vh", color: "#2D283E"}}>
                <b><i>Chat with your personal aiccountant!</i></b>
                <img src={arrow} style={{width: "12%", rotate:"-60deg"}}></img>
            </div>
            <div style={{textAlign: "left", paddingLeft: "2rem", fontFamily: "Segoe UI", fontSize: "2vh", color: "#2D283E"}}>
